...
use agisostack::{hardware_integration::*, name::*};
...
// 	}
    ...
    // let test_internal_ecu = InternalControlFunction::new(test_device_name, 0x1C, 0);
    // 	auto TestPartnerVT = std::make_shared<isobus::PartneredControlFunction>(0, vtNameFilters);
    ...
    // let frame = CanFrame::new(0, &[0xFF; 8]);

    loop {
        // test_internal_ecu.update();
